...
// alert(colindex)
       if (colindex==4) {this.commonService.highlightColumn(colindex,this.srcPdsProjectName)}
       if (colindex==5) {this.commonService.highlightColumn(colindex,this.srcPdsProjectLocation)}
       if (colindex==1) {this.commonService.highlightColumn(colindex,this.srcOwnerContact)}
       if (colindex==2) {this.commonService.highlightColumn(colindex,this.srcClientContact)}
       ...
       if (colindex==3) {this.commonService.highlightColumn(colindex,this.srcPdsProjectDescription)}
