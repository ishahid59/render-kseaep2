  ...
  loadDatatableEmpProjects() {
    ...
    this.dtOptions = {
      ...
      columns: [
        ...
        {
          "data": "ProjectName", "visible": false, "mRender": function (data: any, type: any, row: any) {
        ...
        
        {
          ...
          }, title: 'DurationFrom', "visible": false
        },
        {
          render: (data: any, type: any, row: any) => {
            return this.datePipe.transform(row.DurationTo, "MM/dd/yyyy");
          }, title: 'DurationTo', "visible": false
        },
        { "data": "MonthsOfExp", "className": "dt-center", "visible": false },
