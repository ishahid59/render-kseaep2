...
exports.callJSForProposalDetail = function () {
        ...
        $('#multiple-checkboxes3').multiselect({
            ...
            buttonText: function (options) {
              ...
              onChange: function (element, checked) {
                var brands = $('#multiple-checkboxes3 option:selected');
                var selected = [];
                ...
                // alert(selected);
                // Array value is stored in a input control with id multiSelectedIdsEditModalProposal
               
                $("#multiSelectedIdsEditModalProposal").val(selected);// store array in input control for multi secproject search
                $("#secondaryprojecttypeproposal").val(selected);// store array in input control for multi secproject search
    ...
    $("#clearMultiSelect3").click(function () {
        $("#multiple-checkboxes3").multiselect("clearSelection");// WORKING clear Bootstrap multiselect
